...
$router->group(['middleware' => 'auth:provider'], function($app) {
    ...
    $app->get('/walletamount', 'V1\Common\User\HomeController@walletamount');
    ...
    $app->get('/services_status/{id}', 'V1\Common\Provider\HomeController@services_status');
    ...
    $app->get('/ticket-category/{type}', 'V1\Common\Admin\Resource\TicketCategoryController@ticketCategory');
    $app->post('new-ticket', 'V1\Common\Admin\Resource\TicketsController@store');
    $app->get('my_tickets', 'V1\Common\Admin\Resource\TicketsController@index');
    $app->get('closed_tickets', 'V1\Common\Admin\Resource\TicketsController@closedIndex');
    $app->get('tickets/{ticket_id}', 'V1\Common\Admin\Resource\TicketsController@show');
    ...
    $app->get('/tickets/{id}/updateStatus', 'V1\Common\Admin\Resource\TicketsController@updateStatus');
});
