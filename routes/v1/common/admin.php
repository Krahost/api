...
$router->group(['middleware' => 'auth:admin'], function ($app) {
    ...
    $app->get('/users/{id}/updateStatus', ['uses' => 'V1\Common\Admin\Resource\UserController@updateStatus', 'middleware' => ['permission:user-edit','demo']]);
    ...
    $app->get('/document/{id}/updateStatus', ['uses' =>  'V1\Common\Admin\Resource\DocumentController@updateStatus', 'middleware' => ['permission:documents-Status', 'demo']]);

    //Unit
    $app->get('/unit', ['uses' => 'V1\Common\Admin\Resource\UnitController@index', 'middleware' => ['permission:documents-list']]);

    $app->post('/unit', ['uses' => 'V1\Common\Admin\Resource\UnitController@store', 'middleware' => ['permission:documents-create']]);

    $app->get('/unit/{id}', ['uses' => 'V1\Common\Admin\Resource\UnitController@show', 'middleware' => ['permission:documents-list']]);

    $app->patch('/unit/{id}', ['uses' => 'V1\Common\Admin\Resource\UnitController@update', 'middleware' => ['permission:documents-edit', 'demo']]);

    $app->delete('/unit/{id}', ['uses' => 'V1\Common\Admin\Resource\UnitController@destroy', 'middleware' => ['permission:documents-delete', 'demo']]);

    $app->get('/unit/{id}/updateStatus', 'V1\Common\Admin\Resource\UnitController@updateStatus');
    ...
    $app->get('/reason/{id}/updateStatus',['uses' => 'V1\Common\Admin\Resource\ReasonController@updateStatus','middleware' => ['permission:update-reasons-Status', 'demo']]);
    ...
    $app->get('/fleet/{id}/updateStatus', ['uses' => 'V1\Common\Admin\Resource\FleetController@updateStatus', 'middleware' => ['permission:fleet-list','demo']]);
    ...
    $app->get('/geofence/{id}/updateStatus', ['uses' => 'V1\Common\Admin\Resource\GeofenceController@updateStatus', 'middleware' => ['permission:geofence-list','demo']]);
    ...
    $app->post('/provider', ['uses' => 'V1\Common\Admin\Resource\ProviderController@store', 'middleware' => ['permission:provider-create','demo']]);
    ...
    $app->get('/provider/{id}/updateStatus', ['uses' => 'V1\Common\Admin\Resource\ProviderController@updateStatus', 'middleware' => ['permission:provider-status','demo']]);
    ...
    $app->get('/subadmin/{id}/updateStatus', ['middleware' => 'demo', 'uses' => 'V1\Common\Admin\Resource\AdminController@updateStatus']);
    ...
    $app->get('my_tickets', 'V1\Common\Admin\Resource\TicketsController@indexAll');

    $app->get('ticketComments/{id}', 'V1\Common\Admin\Resource\TicketsController@ticketComment');
    $app->post('/newcomment', 'V1\Common\Admin\Resource\TicketsController@postComment');
    $app->get('/tickets/{id}/updateStatus', ['uses' => 'V1\Common\Admin\Resource\TicketsController@updateStatus','middleware' => 'demo']);
    //tickets
    $app->get('/ticketCategory', ['uses' => 'V1\Common\Admin\Resource\TicketCategoryController@index']);

    $app->post('/ticketCategory', ['uses' => 'V1\Common\Admin\Resource\TicketCategoryController@store','middleware' => 'demo']);

    $app->get('/ticketCategory/{id}', ['uses' => 'V1\Common\Admin\Resource\TicketCategoryController@show']);

    $app->patch('/ticketCategory/{id}', ['uses' => 'V1\Common\Admin\Resource\TicketCategoryController@update', 'middleware' => 'demo']);
     $app->get('/ticketCategory/{id}/updateStatus', ['uses' =>'V1\Common\Admin\Resource\TicketCategoryController@updateStatus','middleware' => 'demo']);
     
    $app->delete('/ticketCategory/{id}', ['uses' => 'V1\Common\Admin\Resource\TicketCategoryController@destroy', 'middleware' => 'demo']);
    ...
    $app->get('/provider/approve_vehicle/{id}', 'V1\Common\Admin\Resource\ProviderController@approve_vehicle');

    $app->post('/provider/vehicle_reject', 'V1\Common\Admin\Resource\ProviderController@vehicle_reject');

    $app->post('/provider/document_reject', 'V1\Common\Admin\Resource\ProviderController@document_reject');
    ...
    $app->get('/companycountries/{id}/updateStatus', ['middleware' => 'demo', 'uses' => 'V1\Common\Admin\Resource\CompanyCountriesController@updateStatus']);
    ...
    $app->get('/zones/{id}/updateStatus', ['middleware' => 'demo', 'uses' => 'V1\Common\Admin\Resource\ZoneController@updateStatus']);
    ...
    $app->get('/payrolls/{id}/updateStatus', ['middleware' => 'demo', 'uses' => 'V1\Common\Admin\Resource\PayrollController@updateStatus']);
