...
$app->post('/push-subscription','V1\Order\Admin\Resource\ShopsController@push_subscription');
//Notification
...
$app->post('/promocode', 'V1\Common\Admin\Resource\PromocodeController@store');
$app->get('/promocode/{id}', 'V1\Common\Admin\Resource\PromocodeController@show');
$app->patch('/promocode/{id}','V1\Common\Admin\Resource\PromocodeController@update');
$app->delete('/promocode/{id}', 'V1\Common\Admin\Resource\PromocodeController@destroy');
