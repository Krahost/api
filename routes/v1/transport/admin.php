...
$router->group(['middleware' => 'auth:admin'], function ($app) {
    ...
    $app->get('/getvehicletype', 'V1\Transport\Admin\VehicleController@getvehicletype');
		...
		$app->get('/vehicle/{id}/updateStatus', ['middleware' => 'demo', 'uses' => 'V1\Transport\Admin\VehicleController@updateStatus']);
		...
		$app->delete('/requestdispute/{id}', ['middleware' => 'demo', 'uses' => 'V1\Transport\Admin\RideRequestDisputeController@destroy']);			
		// request history
		...
		$app->get('/vehicletype/{id}/updateStatus', ['middleware' => 'demo', 'uses' => 'V1\Transport\Admin\VehicleTypeController@updateStatus']);
